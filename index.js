...
console.log("task1 a", createMenuItem("tacos", 8 ,"lunch"));
  }
...
*/
console.log("task1 b", createMenuItem)("fried chicken", 5, "dinner");
console.log("task1 b", createMenuItem("macaroni salad", 3, "lunch"));
console.log("task1 b", createMenuItem("waffles", 6, "breakfast"));
...
*/
reviews.push({name: "Montrell",  rating: 5, feedback: "It was great!"})
...
function addReview(name,rating,feedback){
  let reviews = newarray( "Billy", 2, "Lame food")
...
function getReviewByIndex(array,number) {
  return "${array[number].name} gave the returaunt a ${array[number].rating} star review and their feedback was ${array[number].feedback}";
...
function getLastReview(array, name,reviews) {
